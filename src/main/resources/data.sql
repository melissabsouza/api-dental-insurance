...
CREATE TABLE T_CHALLENGE_SINISTRO (
                                      id_sinistro INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                      descricao_sinistro VARCHAR(1000),
                                      resultado_sinistro VARCHAR(10000)
);
